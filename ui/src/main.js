...
class Choco extends React.Component {
  ...
  fetchQuestions = () => {
    return fetch("http://192.168.0.190:8000/generate/", {
      method: "POST",
      body: JSON.stringify({
  ...
  render() {
    return (
      <div className="container">
        ...
        <div className={(this.state.clicked || this.state.submit) ? "clicked-container" : ""}>
          ...
          {/* style={{"marginLeft":"25px","marginTop":"5px","fontWeight":"bold"}} */}
          <div className="row">
            <div className="question">
              {this.state.showQuestions && (
                <span style={{ marginLeft: "10px", fondWeight: "bold","fontSize":"20px" }}>
          ...
          <div className="row options" style={{"marginTop":"15px"}}>
            {this.state.showQuestions && (
              ...
              // />
              <div>
              <div className="col-md-10 options" style={{ "marginLeft": "20px","marginTop":"5px" }}>
                <button
                  className={
        ...
        <div className="row" style={{"marginLeft":"400px","marginTop":"-150px"}}>
